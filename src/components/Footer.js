      ...
      <div className="container pt-5">
        <div className="row">
          ...
          <div className="col-6 col-md-2 mb-3">
            ...
            <ul className="nav flex-column">
              <li className="nav-item mb-2">
                <Link to="/category/hardware" className="nav-link p-0 text-dark-emphasis">
                  - Hardware
                </Link>
              </li>
              <li className="nav-item mb-2">
                <Link to="/category/monitores" className="nav-link p-0 text-dark-emphasis">
                  - Monitores
                </Link>
              </li>
              <li className="nav-item mb-2">
                <Link to="/category/perifericos" className="nav-link p-0 text-dark-emphasis">
                  - Periféricos
                </Link>
              </li>
              <li className="nav-item mb-2">
                <Link to="/category/acessorios" className="nav-link p-0 text-dark-emphasis">
                  - Acessórios
                </Link>
              </li>
            </ul>
          ...
          <div className="col-md-6 offset-md-2 mb-3">
            <form>
              ...
              <p className="text-dark-emphasis">Resumo mensal do que há de novo e promoções de tirar o folego.</p>
              <div className="d-flex flex-column flex-sm-row w-100 gap-2">
                ...
                <input
                  ...
                  placeholder="E-mail"
                />
                <button className="btn btn-success fw-semibold" type="button">
                  Inscrever
                </button>
              </div>
            </form>
        ...
        <div className="d-flex flex-column flex-sm-row justify-content-between pt-4 border-top">
          <p className="text-dark-emphasis">© 2023 BitsHouse, Todos os direitos reservados.</p>
